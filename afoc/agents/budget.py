...
class AllocationResponse(BaseModel):
    ...
    diagnostics: Dict[
        str, float | str
    ]  # Security: diagnostics include solver labels for audit transparency.
...
class BudgetAgent:
    ...
    async def allocate(self, request: AllocationRequest) -> AllocationResponse:
        ...
        if self._event_bus:
            ...
            )  # Security: modern dump keeps allocation telemetry consistent for downstream tamper checks.
        return response
