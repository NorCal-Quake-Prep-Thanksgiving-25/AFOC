...
from random import (
    SystemRandom,
)  # Security: SystemRandom draws from OS entropy while avoiding insecure PRNG warnings.
...
def test_roi_engine_learns_preference_structure() -> None:
    rng = SystemRandom()  # Security: mirror production allocator entropy inside the test harness.
